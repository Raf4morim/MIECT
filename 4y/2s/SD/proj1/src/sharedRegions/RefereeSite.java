 ...
 *  Referee Site.
 * 
 *  It is responsible for maintaining the state and managing the actions of the referee.
...
public class RefereeSite {
    ...
    */
     ...
     * 
     * It is called by the referee to announce a new game on the start of the match or after a game ends.
     * 
     */

    public synchronized void announceNewGame() {
        // Contestant contestant = null;
        // for (int teamId = 0; teamId < SimulPar.C; teamId++) {
        //     List<Integer> contestantIds =  ((Referee) Thread.currentThread()).getContestantID(teamId);
        //     for (int idPlayer: contestantIds) {
        //         contestant = getContestant(idPlayer);
        //         if (contestant != null){
        //             System.out.println("AnnounceNewGame FORÇA " + contestant.getStrength() + " is ready to play id:" + idPlayer);
        //             repos.setContestantStrength(idPlayer, contestant.getStrength());
        //         }
        //     }
        // }
        nGames++;
     ...
     * 
     * It is called by the referee after a game has come to an end (either by trials or KO);
    ...
    public synchronized boolean declareGameWinner(int posRope) {
        ...
        ((Referee) Thread.currentThread()).setRefereeState(RefereeState.WAIT_UNTIL_ALL_SEATED);
