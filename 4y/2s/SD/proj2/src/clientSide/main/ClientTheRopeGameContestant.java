...
public class ClientTheRopeGameContestant {
	/**
	 * Main method.
	 *
	...
	public static void main(String[] args) {
		...
		int strengthPerContestant[] = new int[SimulPar.P];
		...
		for (int i = 0; i < SimulPar.P / 2; i++) {
			contestants[i] = new Contestant("Contestant_" + i, i, 0, strengthPerContestant[i], playGroundStub,
					benchStub,
					refereeSiteStub);
		}

		for (int i = SimulPar.P / 2; i < SimulPar.P; i++) {
			contestants[i] = new Contestant("Contestant_" + i, i, 1, strengthPerContestant[i], playGroundStub,
					benchStub,
					refereeSiteStub);
		}
