...
public class ClientTheRopeGameCoach {
	 ...
	 * 
	 *             args[4] - name of the platform where is located the referee server
	...
	public static void main(String[] args) {
		...
		List<Integer> playersTeam2 = new ArrayList<Integer>();
		for (int i = 0; i < 5; i++) {
			playersTeam1.add(i);
			playersTeam2.add(i + 5);
		}

		coach[0] = new Coach("Coach_" + 0, 0, playersTeam1, benchStub, refereeSiteStub, playGroundStub);
		coach[1] = new Coach("Coach_" + 1, 1, playersTeam2, benchStub, refereeSiteStub, playGroundStub);
