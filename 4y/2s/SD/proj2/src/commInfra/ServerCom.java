 ...
 * protocol.
 * It supposes the setup of a communication channel between the two end points
 * before data transfer can take place.
 * Data transfer is bidirectional and is made through the transmission and the
 * reception of objects in output and
...
public class ServerCom {
    ...
    /**
     * Service setup.
     * Instantiation of the listening socket and its binding to the public server
     ...
     * Instantiation of the communication socket and its binding to the client
     * address.
    ...
    public Object readObject() {
        ...
        try {
            ...
            System.out
                    .println(Thread.currentThread().getName() + " - error on reading an object from the input stream!");
            e.printStackTrace();
            System.exit(1);
        } catch (ClassNotFoundException e) {
            System.out
                    .println(Thread.currentThread().getName() + " - the read object belongs to an unknown data type!");
            e.printStackTrace();
            System.exit(1);
        }
    ...
    public void writeObject(Object toClient) {
        try {
            ...
            System.out
                    .println(Thread.currentThread().getName() + " - error on writing an object to the output stream!");
            e.printStackTrace();
            System.exit(1);
        }
    }
