...
public class ServerBench {
	...
	public static void main(String[] args) {
		Bench bench; 				// bench (service to be rendered)
		BenchInterface benchInter; 	// interface to the bench
		...
		while (waitConnection) {
			try {
				...
				cliProxy = new BenchClientProxy(sconi, benchInter); // start a service provider agent to address
