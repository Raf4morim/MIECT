...
import serverSide.sharedRegion.RefereeSite;
...
public class ServerRefereeSite {
	...
	public static void main(String[] args) {
		...
		RefereeSiteInterface refereeSiteInter; 	// interface to the referee site
		...
		refereeSiteInter = new RefereeSiteInterface(refereeSite); // interface to the service is instantiated
		...
		while (waitConnection) {
			try {
				...
				cliProxy = new RefereeSiteClientProxy(sconi, refereeSiteInter); // start a service provider agent to address
