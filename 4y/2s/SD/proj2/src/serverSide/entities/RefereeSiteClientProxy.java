...
public class RefereeSiteClientProxy extends Thread implements CoachCloning, ContestantCloning, RefereeCloning {
     ...
     */
    private RefereeSiteInterface refSiteInterface;
     ...
     *     @param refSiteInterface interface to the Referee Site
     */

    public RefereeSiteClientProxy(ServerCom sconi, RefereeSiteInterface refSiteInterface) {
        super("RefereeSiteProxy" + RefereeSiteClientProxy.getProxyId());
        this.sconi = sconi;
    ...
    public void run() {
        ...
        try {
            outMessage = refSiteInterface.processAndReply(inMessage); // process it
