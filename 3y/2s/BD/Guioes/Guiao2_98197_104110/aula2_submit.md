...
| Produtos     | Código, Nome, Preço, Taxa de IVA, Stock      |
| Fornecedor    | Nome, NIF, Endereço, Número de Fax, Condições de Pagamento |
| Tipo de Fornecedor     | Código Interno, Designação    |
...
| Relações                               |   Grau   | Cardinalidade   | Obrigatoriedade |
| - | :-: | :-: | :-: |
| Entre Encomenda e Produtos (Contém)        |   Relação Binária |  N:M  | Obrigatório do lado da Encomenda<br>Opcional do lado do Produtos |
| Entre Fornecedor e Encomenda (Tem)           |   Relação Binária |  1:N  | Opcional do lado do Fornecedor<br>Obrigatório do lado da Encomenda 
| Entre Fornecedor e Tipo de Fornecedor (Tipo)  |   Relação Binária |  M:N  | Obrigatório do lado da Fornecedor<br>Opcional do lado do Tipo de Fornecedor 
