...
class Association(Relation):
    def __init__(self,e1,name,e2,card=None,default=None):
        ...
        self.card = card 
        # None - To be used between objects, for example, entity1 e entity2 are necessarily names of objects.
        ...
        # default - To be used for associations between types. It specifies the default value (second argument) of the association. Only associations with cardinality "one" can have a default value. Example: by default, the hight of a "man"is 1.75.
    def __str__(self):
        if self.card==None:
            default=""
